...
pheatmap(cor(p.usage.df.neb[,-1], use='pairwise.complete.obs'))
pheatmap(cor(p.usage.df.kapa[,-1], use='pairwise.complete.obs'))
```
...
pheatmap(cor(t.usage.df.neb[,-1], use='pairwise.complete.obs'))
pheatmap(cor(t.usage.df.kapa[,-1], use='pairwise.complete.obs'))
```
