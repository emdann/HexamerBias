...
python bin/coverage_bias/hexVSprimed.py /hpc/hub_oudenaarden/edann/crypts_bs/VAN1667/L1_R2.fastq.gz /hpc/hub_oudenaarden/edann/hexamers/L1_R2_primed_seq.original.fa
