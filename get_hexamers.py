...
# bamfile='./crypts_bs/VAN1667/L1_trim1_R1_bismark_bt2_pe.deduplicated.bam'
# fasta='./edann/crypts_bs/VAN1667/L1_R1.fastq.gz'

ids_r1=[]
ids_r2=[]
with ps.AlignmentFile(args.bam,"rb") as bam:
...
fq1_dict={}
with ps.FastxFile(args.fasta1) as fastq:
 	for entry in fastq:
...
for kmer, abundance in hex_count.most_common(): # sorts by abundance
