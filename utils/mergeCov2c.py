...
argparser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter, description="Merge coverage 2 cytosine output files from Bismark methylation extraction. By Emma Dann")
