...
def genome_wide_artificial_coverage(genomefile,covFile,abundanceFile, outfile):
...
genome_wide_artificial_coverage(genomefile, covFile, abundanceFile, outfile='mm10.artificial_cov.VAN1667avg.bed')
